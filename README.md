...
```
或者在Windows上，直接下载预构建的exe版本：[github.com/ekcbw/multimodel-chat/releases/latest](https://github.com/ekcbw/multimodel-chat/releases/latest)
...
python multimodel_chat.py
```
Additionally, you can directly download the pre-built exe version for Windows: [github.com/ekcbw/multimodel-chat/releases/latest](https://github.com/ekcbw/multimodel-chat/releases/latest)
